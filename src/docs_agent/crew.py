...
from docs_agent.tools.wikipedia_tool import WikipediaSearchTool
import os

# Define the LLM
# This will use the MODEL and API_BASE from .env
my_llm = LLM(
...
class WikipediaResearchCrew():
    ...
    def wikipedia_researcher(self) -> Agent:
        return Agent(
            config=self.agents_config['wikipedia_researcher'], # type: ignore[index]
